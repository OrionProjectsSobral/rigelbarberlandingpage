    ...
    <section className="w-full py-16 sm:py-24 px-4 sm:px-6 bg-background flex justify-center">
      <div className="max-w-[1200px] w-full flex flex-col md:flex-row gap-12 sm:gap-16 md:gap-24 items-center">
        ...
        >
          ...
          <div className="pt-6">
            <a href="#funcionalidades" className="group flex w-fit items-center gap-4 text-primary text-xs font-black uppercase tracking-widest border-b-2 border-primary pb-2 hover:text-foreground hover:border-foreground transition-all">
              Ver funcionalidades
              <ArrowRight
                size={16}
