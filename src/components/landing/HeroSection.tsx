...
const HeroSection = () => {
  return (
    <section className="relative w-full py-16 sm:py-20 md:py-32 px-4 sm:px-6 flex justify-center data-grid overflow-hidden">
      <div className="max-w-[1200px] w-full flex flex-col-reverse md:flex-row gap-16 items-center">
        ...
        >
          <div className="flex flex-col gap-6">
            ...
            <h2 className="text-text-secondary text-base sm:text-lg md:text-xl font-medium leading-relaxed max-w-[550px] mx-auto md:mx-0 border-l-2 border-border pl-4 sm:pl-6">
